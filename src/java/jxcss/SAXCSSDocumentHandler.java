...
e.printStackTrace();
    ...
    private void selector(Selector selector) throws SAXException {
    ...
    private void anyNodeSelector() throws SAXException {
        element(ANY_NODE_SELECTOR);
    }

    private void descendantSelector(DescendantSelector descendantSelector, String elementName) throws SAXException {
    ...
    private void characterDataSelector(CharacterDataSelector characterDataSelector, String elementName) throws SAXException {
        textElement(elementName, characterDataSelector.getData());
    }

    private void conditionalSelector(ConditionalSelector conditionalSelector) throws SAXException {
    ...
    private void siblingSelector(SiblingSelector siblingSelector) throws SAXException {
    ...
    private void elementSelector(ElementSelector elementSelector, String elementName) throws SAXException {
        addAttribute(LOCAL_NAME, elementSelector.getLocalName());
        addAttribute(NAMESPACE_URI, elementSelector.getNamespaceURI());
        element(elementName);
    }

    private void negativeSelector(NegativeSelector negativeSelector) throws SAXException {
        startElement(NEGATIVE_SELECTOR);
        selector(negativeSelector.getSimpleSelector());
        endElement(NEGATIVE_SELECTOR);
    }

    private void processingInstructionSelector(ProcessingInstructionSelector processingInstructionSelector) throws SAXException {
    ...
    private void rootNodeSelector() throws SAXException {
        element(ROOT_NODE_SELECTOR);
    }

    private void condition(Condition condition) throws SAXException {
    ...
    private void combinatorCondition(CombinatorCondition combinatorCondition, String elementName) throws SAXException {
        startElement(elementName);
    ...
    private void negativeCondition(NegativeCondition negativeCondition) throws SAXException {
        startElement(NEGATIVE_CONDITION);
        condition(negativeCondition.getCondition());
        endElement(NEGATIVE_CONDITION);
    }

    private void positionalCondition(PositionalCondition positionalCondition) throws SAXException {
    ...
    private void attributeCondition(AttributeCondition attributeCondition, String elementName) throws SAXException {
    ...
    private void langCondition(LangCondition langCondition) throws SAXException {
        addAttribute(LANG, langCondition.getLang());
        element(LANG_CONDITION);
    }

    private void onlyChildCondition() throws SAXException {
        element(ONLY_CHILD_CONDITION);
    }

    private void onlyTypeCondition() throws SAXException {
        element(ONLY_TYPE_CONDITION);
    }

    private void contentCondition(ContentCondition contentCondition) throws SAXException {
        textElement(CONTENT_CONDITION, contentCondition.getData());
    }

    private void lexicalValue(LexicalUnit lexicalUnit) throws SAXException {
        if (lexicalUnit != null) {
